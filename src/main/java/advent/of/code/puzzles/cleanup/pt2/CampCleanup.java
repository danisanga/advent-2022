package advent.of.code.puzzles.cleanup.pt2;
...
public class CampCleanup {
    ...
    private static List<Integer> getNumbersUsingIntStreamRangeClosed(final int start, final int end) {
